...
func (uc *UserCreate) SetIDAuthorize(u uuid.UUID) *UserCreate {
	uc.mutation.SetIDAuthorize(u)
	return uc
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.IDAuthorize(); !ok {
		return &ValidationError{Name: "id_authorize", err: errors.New(`ent: missing required field "User.id_authorize"`)}
	}
	return nil
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.IDAuthorize(); ok {
		_spec.SetField(user.FieldIDAuthorize, field.TypeUUID, value)
		_node.IDAuthorize = value
	}
