...
// The AuthorizeFunc type is an adapter to allow the use of ordinary
// function as Authorize mutator.
type AuthorizeFunc func(context.Context, *ent.AuthorizeMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AuthorizeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AuthorizeMutation); ok {
		return f(ctx, mv)
	}
...
func (f RoomInfoFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RoomInfoMutation); ok {
		return f(ctx, mv)
	}
...
// The UsernamePasswordFunc type is an adapter to allow the use of ordinary
// function as UsernamePassword mutator.
type UsernamePasswordFunc func(context.Context, *ent.UsernamePasswordMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UsernamePasswordFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UsernamePasswordMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UsernamePasswordMutation", m)
}
