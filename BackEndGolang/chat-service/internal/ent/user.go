...
type User struct {
	...
	// IDAuthorize holds the value of the "id_authorize" field.
	IDAuthorize uuid.UUID `json:"id_authorize,omitempty"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldName, user.FieldAvatarURL:
			values[i] = new(sql.NullString)
		case user.FieldID, user.FieldIDAuthorize:
...
func (u *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldIDAuthorize:
			if value, ok := values[i].(*uuid.UUID); !ok {
				return fmt.Errorf("unexpected type %T for field id_authorize", values[i])
			} else if value != nil {
				u.IDAuthorize = *value
			}
		default:
...
func (u *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("id_authorize=")
	builder.WriteString(fmt.Sprintf("%v", u.IDAuthorize))
	builder.WriteByte(')')
